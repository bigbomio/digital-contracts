/**
 * Created on 2018-08-10 14:57
 * @summary: Payment Contract for Marketplace DApp 
 * @author: Chris Nguyen
 */
...
/**
 * @title: Smart contract for handling payment between the Hirer and the Freelancer
 */
